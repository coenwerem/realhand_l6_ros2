...
The repository is licensed under Apache-2.0. The meshes are derived from the vendor's Apache-2.0 [linkerhand-urdf](https://github.com/linker-bot/linkerhand-urdf) release. The vendor SDK is available from [RealHand-Robotics](https://github.com/RealHand-Robotics). The `realhand_hardware` driver is independent of the vendor SDK and implements the CAN protocol directly within the driver.
